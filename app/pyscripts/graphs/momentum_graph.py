def showMomentumGraph(maxParticles):
    # main module to display momentum graph
    ...
    getFileContents(maxParticles, "momentum_data")
    ...
    def update(i):
        ...
        try:
            ...
            for i, xPoints in enumerate(xList):
                xPoints.append(fileContentsList[i].iloc[index, 0])
            for i, yPoints in enumerate(yList):
                yPoints.append(fileContentsList[i].iloc[index, 1])
